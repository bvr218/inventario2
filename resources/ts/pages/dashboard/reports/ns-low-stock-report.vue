                        ...
                        <table class="table ns-table w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th width="150" class="border p-2 text-right">Costo Compra</th>
                                    <th width="150" class="border p-2 text-right">{{ __( 'Quantity' ) }}</th>
                                    <th width="150" class="border p-2 text-right">Costo Compra Total</th>
                                ...
                                <template v-if="stockReportResult.data !== undefined">
                                    <template v-for="product of stockReportResult.data">
                                        <tr :key="key" v-for="(unitQuantity,key) of product.unit_quantities" class="text-sm">
                                            ...
                                            <td class="p-2 border text-right">{{ nsCurrency(  unitQuantity.cogs ) }}</td>
                                            <td class="p-2 border text-right">{{ unitQuantity.quantity }}</td>
                                            <td class="p-2 border text-right">{{ nsCurrency( unitQuantity.quantity * unitQuantity.cogs ) }}</td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="p-2 border text-right">{{ nsCurrency( totalSum( stockReportResult, 'cogs', 'quantity' ) ) }}</td>
