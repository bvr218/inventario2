...
class ReportsController extends DashboardController
{
    ...
    {
        return View::make( 'pages.dashboard.reports.close-report', [
            'title' => __( 'Close Report' ),
            'description' => __( 'Provides an overview over the close during a specific period' ),
        ] );
    }
    ...
    public function getCloseReport( Request $request )
    {
        return $this->reportService
            ->getCloseReport(
                $request->input( 'startDate' ),
